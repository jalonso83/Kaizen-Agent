---
name: lectura-kpis-social
description: Úsalo para leer los KPIs del SISTEMA SOCIAL de FinZen (Instagram y TikTok): los 5 del funnel (registros atribuidos, clicks al link, moneda social, retención de video, seguidores netos) y el pulso (views, likes). Para los KPIs del tablero interno y de la Agent API, el skill es lectura-kpis-finzen.
---
