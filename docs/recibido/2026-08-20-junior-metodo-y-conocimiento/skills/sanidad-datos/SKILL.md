---
name: sanidad-datos
description: Úsalo cuando un número se mueva >20%, cuando dos pantallas o dos fuentes den cifras distintas para lo mismo, o siempre antes de declarar un récord, una caída o un resultado rojo. Distingue problema de tubería (dato roto) de problema de negocio (realidad rota).
---
